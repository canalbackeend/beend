                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <ol className="text-sm text-muted-foreground space-y-1 ml-4 list-decimal">
                          <li>Baixe o APK do link: <code className="bg-muted px-1 py-0.5 rounded">https://www.backeend.com.br/beend.apk</code></li>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    ...
                    <p className="text-sm text-green-800 dark:text-green-200">
                      Para aumentar o número de terminais permitidos, entre em contato com o administrador do sistema através do e-mail: <strong>contato@beend.com.br</strong>
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground mb-2">
                        URL: <code className="bg-muted px-2 py-1 rounded">https://beend.app/terminal-panel/login</code>
                      </p>
                      <p className="text-sm text-muted-foreground">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-background rounded-lg border">
                    ...
                    <a href="mailto:contato@beend.com.br" className="text-blue-600 hover:underline">
                      contato@beend.com.br
                    </a>
                  </div>
                  <div className="p-4 bg-background rounded-lg border">
